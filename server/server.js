...
var Ke = /** @class */ (function () {
    function Ke(id, kename, images, describe, time, person, video) {
        this.id = id;
        this.kename = kename;
        this.images = images;
...
exports.Ke = Ke;
var Sheqv = /** @class */ (function () {
    function Sheqv(id, images, shename, content, writer, time, read, discuss) {
        this.id = id;
        this.images = images;
...
var courses = [
    ...
    new Course(2, '2017-12-软件测试基础', "http://usercontent.edu2act.cn/media/team/18-05-31/GvVrSCw2H2XBgXjLdgTvmc.jpeg?imageView2/1/w/230/h/130", 1, 104),
    new Course(3, '2017级Web开发2', "http://usercontent.edu2act.cn/media/team/18-09-11/Ypf253J7ydMQ2CckxWf6zJ.jpg?imageView2/1/w/230/h/130", 2, 399),
    ...
    new Course(5, '2016级H5与css3前端开发', "http://usercontent.edu2act.cn/media/team/18-09-11/B32yP44hiothFxyegigXe7.jpg?imageView2/1/w/230/h/130", 1, 104),
    ...
    new Course(8, '2018级计算机导论', "http://usercontent.edu2act.cn/media/team/18-09-06/HUcdGNR48SfNpHPRjGQqXb.jpg?imageView2/1/w/230/h/130", 1, 382),
    new Course(9, '2018-2019第一学期面对对象程序设计', "http://usercontent.edu2act.cn/media/team/18-05-31/GvVrSCw2H2XBgXjLdgTvmc.jpeg?imageView2/1/w/230/h/130", 3, 400),
    ...
    new Course(11, '软件学院2018级新生训练营', "http://usercontent.edu2act.cn/media/team/18-07-09/3ydhisn3DM8PR9hNY9vCjA.jpg?imageView2/1/w/230/h/130", 0, 78),
    new Course(12, '2017coding暑假训练营', "http://usercontent.edu2act.cn/media/team/18-07-09/J3LxZ5cMMP9JFjGuDbSsh8.png?imageView2/1/w/230/h/130", 13, 92),
];
var kecheng = [
...
app.get('/api/sheqv', function (req, res) {
    res.json(sheqv);
});
app.get('/api/kecheng/:id', function (req, res) {
    res.json(kecheng.find(function (ele) { return ele.id == req.params.id; }));
});
